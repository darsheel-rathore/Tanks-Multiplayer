...
namespace Complete
{
    public class MPTankShooting : MonoBehaviourPun
    {
        ...
        private void Fire()
        {
            ...
            this.photonView.RPC("FireShell", RpcTarget.All, m_CurrentLaunchForce);
        ...
        [PunRPC]
        private void FireShell(float currentLaunchForce)
        {
